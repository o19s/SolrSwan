...
import com.o19s.solr.swan.highlight.SpanAwareFieldQuery.QueryPhraseMap;
...
public class FieldPhraseList {
   ...
   */
  public FieldPhraseList( SpanAwareFieldTermStack fieldTermStack, SpanAwareFieldQuery fieldQuery){
   ...
   */
  public FieldPhraseList( SpanAwareFieldTermStack fieldTermStack, SpanAwareFieldQuery fieldQuery, int phraseLimit ){
    final String field = fieldTermStack.getFieldName();

    LinkedList<TermInfo> phraseCandidate = new LinkedList<TermInfo>();
    QueryPhraseMap currMap;
    QueryPhraseMap nextMap;
