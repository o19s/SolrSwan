 ...
 *
 */
public class SASimpleFragmentsBuilder extends SABaseFragmentsBuilder {

  /**
   * a constructor.
   */
  public SASimpleFragmentsBuilder() {
    super();
  }
   ...
   */
  public SASimpleFragmentsBuilder(String[] preTags, String[] postTags ) {
    super( preTags, postTags );
  }

  public SASimpleFragmentsBuilder(BoundaryScanner bs ) {
    super( bs );
  }

  public SASimpleFragmentsBuilder(String[] preTags, String[] postTags, BoundaryScanner bs ) {
