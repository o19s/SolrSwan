...
/**
 * An implementation class of {@link SAFragListBuilder} that generates one {@link WeightedFragInfo} object.
 ...
 * </pre>
 */
public class SASingleFragListBuilder implements SAFragListBuilder {

  @Override
  public SAFieldFragList createFieldFragList(SAFieldPhraseList fieldPhraseList,
                                             int fragCharSize) {

    SAFieldFragList ffl = new SASimpleFieldFragList( fragCharSize );
