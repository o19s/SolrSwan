...
import com.o19s.solr.swan.highlight.spanawarevectorhighlight.SAFieldQuery.QueryPhraseMap;
 ...
 */
public class SAFieldPhraseList {
  /**
   ...
   */
  public SAFieldPhraseList(SAFieldTermStack fieldTermStack, SAFieldQuery fieldQuery){
   ...
   */
  public SAFieldPhraseList(SAFieldTermStack fieldTermStack, SAFieldQuery fieldQuery, int phraseLimit ){
   ...
   */
  public SAFieldPhraseList(SAFieldPhraseList[] toMerge ) {
    ...
    int index = 0;
    for ( SAFieldPhraseList fplToMerge : toMerge ) {
