 ...
 */
public class SASimpleBoundaryScanner implements BoundaryScanner {
  ...
  public SASimpleBoundaryScanner(){
    this( DEFAULT_MAX_SCAN, DEFAULT_BOUNDARY_CHARS );
  }
  
  public SASimpleBoundaryScanner(int maxScan ){
    this( maxScan, DEFAULT_BOUNDARY_CHARS );
  }
  
  public SASimpleBoundaryScanner(Character[] boundaryChars ){
    this( DEFAULT_MAX_SCAN, boundaryChars );
  }
  
  public SASimpleBoundaryScanner(int maxScan, Character[] boundaryChars ){
    this.maxScan = maxScan;
    this.boundaryChars = new HashSet<>();
    this.boundaryChars.addAll(Arrays.asList(boundaryChars));
  }
  
  public SASimpleBoundaryScanner(int maxScan, Set<Character> boundaryChars ){
    this.maxScan = maxScan;
