...
public class SAFieldTermStack {
   ...
   * @param spanAwareFieldQuery FieldQuery object
   * @throws IOException If there is a low-level I/O error
   */
  public SAFieldTermStack(IndexReader reader, int docId, String fieldName, final SAFieldQuery spanAwareFieldQuery) throws IOException {
    this.fieldName = fieldName;
    
    Set<String> termSet = spanAwareFieldQuery.getTermSet( fieldName );
