...
/**
 * {@link SAFragmentsBuilder} is an interface for fragments (snippets) builder classes.
 * A {@link SAFragmentsBuilder} class can be plugged in to
 * {@link org.apache.lucene.search.vectorhighlight.FastVectorHighlighter}.
 */
public interface SAFragmentsBuilder {
  ...
  public String createFragment( IndexReader reader, int docId, String fieldName,
      SAFieldFragList fieldFragList ) throws IOException;
  ...
  public String[] createFragments( IndexReader reader, int docId, String fieldName,
      SAFieldFragList fieldFragList, int maxNumFragments ) throws IOException;
   ...
   */
  public String createFragment( IndexReader reader, int docId, String fieldName,
      SAFieldFragList fieldFragList, String[] preTags, String[] postTags,
   ...
   */
  public String[] createFragments( IndexReader reader, int docId, String fieldName,
      SAFieldFragList fieldFragList, int maxNumFragments, String[] preTags, String[] postTags,
      Encoder encoder ) throws IOException;
}
