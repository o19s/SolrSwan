 ...
 */
public class SAScoreOrderFragmentsBuilder extends SABaseFragmentsBuilder {

  /**
   * a constructor.
   */
  public SAScoreOrderFragmentsBuilder(){
    super();
  }
   ...
   */
  public SAScoreOrderFragmentsBuilder(String[] preTags, String[] postTags ){
    super( preTags, postTags );
  }

  public SAScoreOrderFragmentsBuilder(BoundaryScanner bs ){
    super( bs );
  }

  public SAScoreOrderFragmentsBuilder(String[] preTags, String[] postTags, BoundaryScanner bs ){
