...
//import com.o19s.solr.swan.highlight.vectorhighlight.SpanAwareFragListBuilder;

/**
 * A abstract implementation of {@link SAFragListBuilder}.
 */
public abstract class SABaseFragListBuilder implements SAFragListBuilder {
  ...
  public SABaseFragListBuilder(int margin ){
    if( margin < 0 )
  ...
  public SABaseFragListBuilder(){
    this( MARGIN_DEFAULT );
  }
  
  public SAFieldFragList createFieldFragList(SAFieldPhraseList fieldPhraseList,
                                             SAFieldFragList fieldFragList, int fragCharSize ){
