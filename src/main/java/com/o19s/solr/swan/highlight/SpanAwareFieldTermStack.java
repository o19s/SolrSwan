 ...
 */
public class SpanAwareFieldTermStack {
  ...
  //  QueryParser _parser = new QueryParser(Version.LUCENE_CURRENT,  "f", analyzer );
  //  Query query = _parser.parse( "a x:b" );
   ...
   */
  public SpanAwareFieldTermStack( IndexReader reader, int docId, String fieldName, final SpanAwareFieldQuery fieldQuery ) throws IOException {
    ...
    while ((text = termsEnum.next()) != null) {
      ...
      for(int i = 0;i < freq;i++) {
        ...
        if (
            alwaysHighlightTermSet.contains(term) ||
